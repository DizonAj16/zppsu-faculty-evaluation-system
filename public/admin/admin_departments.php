                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                $stmt = $pdo->query("
    SELECT d.*, COUNT(p.program_id) AS total_programs
    FROM departments d
...
");
            ...
            <div class="modal fade" id="addDepartmentModal" tabindex="-1" aria-labelledby="addLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <form method="POST" action="../admin/processes/departments_process.php" class="modal-content">
            ...
            <!-- Edit Modal -->
            <div class="modal fade" id="editDepartmentModal" tabindex="-1" aria-labelledby="editLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <form method="POST" action="../admin/processes/departments_process.php" class="modal-content">
            ...
            <div class="modal fade" id="confirmDeleteModalDepartment" tabindex="-1"
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var deleteModal = document.getElementById('confirmDeleteModalDepartment');
        if (deleteModal) {
            deleteModal.addEventListener('show.bs.modal', function (event) {
                var button = event.relatedTarget;
                var departmentId = button.getAttribute('data-department-id');
                var deleteBtn = document.getElementById('confirmDeleteBtnDepartment');
                if (deleteBtn && departmentId) {
                    deleteBtn.href = "../admin/processes/departments_process.php?delete=" + encodeURIComponent(departmentId);
                }
            });
        }
        ...
        if (editModal) {
            editModal.addEventListener('show.bs.modal', function (event) {
                ...
                editModal.querySelector('[data-edit-field="department-name"]').value = departmentName;
                editModal.querySelector('[data-edit-field="department-code"]').value = departmentCode;
            });
        }
    });
</script>
