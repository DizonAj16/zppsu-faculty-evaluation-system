        ...
        <div class="container-fluid p-4">
            ...
            <div class="modal fade" id="addSubjectModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable">
                    <form method="post" action="../admin/processes/subjects_process.php" class="modal-content">
            ...
            <div class="modal fade" id="confirmDeleteModalSubject" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="subject_name"
                                    data-edit-field="subject-name" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Subject Code</label>
                                <input type="text" class="form-control" name="subject_code"
                                    data-edit-field="subject-code" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Program</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Department</label>
                                <select class="form-select" name="department_id" data-edit-field="department-id"
                                    required>
                                    <option value="">-- Select Department --</option>
                                    <?php
                                    $stmt = $pdo->query("SELECT department_id, department_name FROM departments ORDER BY department_name ASC");
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // ✅ DELETE SUBJECT (already added above)
        var deleteModal = document.getElementById('confirmDeleteModalSubject');
        if (deleteModal) {
            deleteModal.addEventListener('show.bs.modal', function (event) {
                var button = event.relatedTarget;
                var subjectId = button.getAttribute('data-subject-id');
                var deleteBtn = document.getElementById('confirmDeleteBtnSubject');
                if (deleteBtn && subjectId) {
                    deleteBtn.href = "../admin/processes/subjects_process.php?delete=" + encodeURIComponent(subjectId);
                }
            });
        }

        // ✅ EDIT SUBJECT - Auto populate modal fields
        ...
        if (editModal) {
            editModal.addEventListener('show.bs.modal', function (event) {
                ...
                var subjectType = button.getAttribute('data-subject-type');

                // Populate fields
                editModal.querySelector('[data-edit-field="subject-id"]').value = subjectId;
                editModal.querySelector('[data-edit-field="subject-name"]').value = subjectName;
                editModal.querySelector('[data-edit-field="subject-code"]').value = subjectCode;
                ...
                editModal.querySelector('[data-edit-field="subject-type"]').value = subjectType;
            });
        }
    });
</script>
