        ...
        <div class="container-fluid p-4">
            ...
            <div class="modal fade" id="addYearSectionModal" tabindex="-1">
                <div class="modal-dialog">
                    <form method="post" action="../admin/processes/year_section_process.php" class="modal-content">
                ...
                <div class="modal-dialog">
                    <form method="post" action="../admin/processes/year_section_process.php" class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Section</label>
                                <input type="text" name="section" class="form-control" data-edit-field="section"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Program</label>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // ✅ DELETE MODAL (already exists)
        var deleteModal = document.getElementById('confirmDeleteModalYearSection');
        if (deleteModal) {
            deleteModal.addEventListener('show.bs.modal', function (event) {
                var button = event.relatedTarget;
                var yearSectionId = button.getAttribute('data-year-section-id');
                var deleteBtn = document.getElementById('confirmDeleteBtnYearSection');
                if (deleteBtn && yearSectionId) {
                    deleteBtn.href = "../admin/processes/year_section_process.php?action=delete&id=" + encodeURIComponent(yearSectionId);
                }
            });
        }

        // ✅ EDIT MODAL (NEW)
        var editModal = document.getElementById('editYearSectionModal');
        if (editModal) {
            editModal.addEventListener('show.bs.modal', function (event) {
                var button = event.relatedTarget;

                // Get values from the clicked Edit button
                var yearSectionId = button.getAttribute('data-year-section-id');
                ...
                editModal.querySelector('[data-edit-field="year-section-id"]').value = yearSectionId;
                editModal.querySelector('[data-edit-field="year"]').value = year;
                editModal.querySelector('[data-edit-field="section"]').value = section;
