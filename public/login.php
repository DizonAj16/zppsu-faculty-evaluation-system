...
<style>
  ...
  .btn-eye-maroon:hover,
  .btn-eye-maroon:focus {
    background-color: #a83232 !important;
    border-color: #a83232 !important;
    color: #fff !important;
  }
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <button class="btn btn-eye-maroon" type="button" id="toggleLoginPassword" tabindex="-1">
                <!-- Eye open icon -->
                <svg id="eyeOpenLogin" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
